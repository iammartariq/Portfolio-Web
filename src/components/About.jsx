...
const About = () => {
  const services = [
    ...
    },
    {
      ...
      title: 'Cybersecurity',
      description: 'Exploring Ethical Hacking and practicing on TryHackMe',
    },
    {
      icon: HiDeviceMobile,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
             I am a dedicated Computer & Information Systems Engineering student with a growing passion for
cybersecurity and software development. Combining strong technical foundations with
practical project experience, I aim to build secure, efficient solutions.
            </motion.p>
