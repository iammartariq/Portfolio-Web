      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <motion.h1
            ...
            <div>Hi👋</div> 
            I'm <span className="gradient-text">Ammar Tariq</span>
          </motion.h1>
          ...
          <motion.p
            ...
            An undergraduate <span className='gradient-text'>COMPUTER AND INFORMATION SYSTEMS ENGINEER</span> 
            <div>exploring the world of computer</div>
          </motion.p>
          ...
          <motion.div
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 glass text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-200 flex items-center justify-center gap-2">
